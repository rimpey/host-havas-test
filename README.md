...
I started with cloning the Angular Seed project as a best practice to setup the project structure (https://github.com/angular/angular-seed). From there I used a flex page structure to hold the nav, sidebar and panels with colours as per the design. I used CSS to transition between full height and 0 height panels along with transition for the sidebar I would do this with ng-animate as a phase II with a bit more time. I just ran out of time working out the show and hide on ng-click and adding classes with Angular. I would also consider how to go about looping through the panels with ng-repeat with a bit more time to research how this might be done.

I got the solution working with adding classes and click events it just needs a little bit more finessing to work on smoother transitions.

https://www.youtube.com/watch?v=VxpW6xAJhcY
